...
import com.course.quiz.data.models.QuestionType
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(view)
        binding.toolbar.setTitle("Quiz #1")
    ...
    private fun submitQuizAndFinish() {
        ...
        builder.setTitle("Submit the Quiz")
        builder.setMessage("Are you sure that you want to submit your quiz")
